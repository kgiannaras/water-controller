...
lcd.print("Tank-O");
delay(delayDisplay);
while((tankfill1 < 85) || (tankfill3 > 5)){
...
lcd.print("Tank-C");
delay(delayDisplay);
while((tankfill2 < 85) || (tankfill3 > 5)){
...
digitalWrite(trigPin3, LOW);
  ...
  buf2[i]= pulseIn(echoPin3, HIGH);// Reads the echoPin, returns the sound wave travel time in microseconds 
  delay(10);
 }
 for(int i=0;i<9;i++)
 {
